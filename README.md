...
* [x] List anything else that you can get done to improve the app functionality:
 	* Clicking on the like/unlike button and retweet button will change colors! 
...
It was pretty difficult to implement the like/unlike buttons at first. I wasn't sure where to place my event listener for the button and how to call the client. But after I figured it out, it was very easy to do the retweet button!
